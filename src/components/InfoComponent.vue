  ...
  data() {
    return {
      instructions: [
        ...
        ["ADDI", "Addition Immediate", "ADDI $R1 $R2 $5", "This instruction adds an immediate value to rs and stores the result in rt."],
        ...
        ["MULI", "Multiply Immediate", "MULI $R1 $R2 $5", "This instruction multiplies the values in rs and rt and stores the result in rd."],
        ...
        ["ANDI", "Bitwise AND Immediate", "ANDI $R1 $R2 $5", "This instruction performs a bitwise AND between rs and an immediate value and stores the result in rt."],
        ["OR", "Bitwise OR", "OR $R1 $R2 $R3", "This instruction performs a bitwise OR between rs and rt and stores the result in rd."],
        ["ORI", "Bitwise OR Immediate", "ORI $R1 $R2 $5", "This instruction performs a bitwise OR between rs and an immediate value and stores the result in rt."],
        ["XOR", "Bitwise XOR", "XOR $R1 $R2 $R3", "This instruction performs a bitwise XOR between rs and rt and stores the result in rd."],
        ["XORI", "Bitwise XOR Immediate", "XORI $R1 $R2 $5", "This instruction performs a bitwise XOR between rs and an immediate value and stores the result in rt."],
        ["NAND", "Bitwise NAND", "NAND $R1 $R2 $R3", "This instruction performs a bitwise NOR between rs and rt and stores the result in rd."],
        ["NANDI", "Bitwise NAND Immediate", "NANDI $R1 $R2 $5", "This instruction performs a bitwise NOR between rs and an immediate value and stores the result in rt."],
